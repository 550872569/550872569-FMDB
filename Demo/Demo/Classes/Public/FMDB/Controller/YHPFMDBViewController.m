...
- (void)configUI {
    ...
    CGRect rectDelete = CGRectMake(110, 20, 100, 50);
    CGRect rectUpdate = CGRectMake(210, 20, 100, 50);
    CGRect rectCheck = CGRectMake(310, 20, 100, 50);
    CGRect rectTableView = CGRectMake(0, 70, SCREEN_WIDTH, SCREEN_HEIGHT-50);
